const sampleBooks = [
  ...
  { id: "ebook-wsl2-online", title: "從 Windows 開始學 Linux", subtitle: "用 WSL2 從安裝一路走到實作、工具鏈與學習節奏", author: "Happy eB target="_blank" rel="noopener noreferrer">下載閱讀</a>` : book.type === "paid" ? `<a class="button primary" href="${book.buyUrl || "#"}" target="_blank" rel="noopener noreferrer">立即購買</a>` : `<a class="button primary" href="${book.readUrl || `book.html?id=${book.id}`}" target="_blank" rel="noopener noreferrerbuyUrl: "", readUrl: "https://j945935cy.github.io/ebook-wsl2/", featured: true, popular: true, priceLabel: "免費閱讀" },
