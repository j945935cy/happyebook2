const sampleBooks = [
  { id: "ai-python-automation", title: "AI Python 自動化實戰", subtitle: "用 Python 與 AI 工具提升工作效率", author: "Happy eBook 編輯部", category: "程式設計", type: "web", format: "網站閱讀", cover: "../assets/images/book-ai-python-automation.svg", description: "整理 AI 與 Python 自動化的實作觀念與應用情境，適合想用程式處理重複工作、建立工作流程與提升效率的讀者。", downloadUrl: "", buyUrl: "", readUrl: "https://j945935cy.github.io/ai-python-automation/web/index.html", featured: true, popular: true, priceLabel: "免費閱讀" },
