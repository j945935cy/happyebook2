const sampleBooks = [
  ...
  { id: "grammar-beginners-day42", title: "英文文法 Day 42", subtitle: "Grammar for Beginners V2 第 42 天教材", author: "Happy eBook 編輯部", category: "英語學習", type: "web", format: "網站閱讀", cover: "../assets/images/book-grammar-beginners.svg", description: "收錄 Grammar for Beginners V2 規劃 42 天的英文文法教材，適合學生自學、課堂補充與教師教學使用。", downloadUrl: "", buyUrl: "", readUrl: "https://j945935cy.github.io/Grammar-for-Beginners-V2/day42/", featured: true, popular: true, priceLabel: "免費閱讀" },
  { id: "grammar-beginners-day21", title: "英文文法 Day 21", subtitle: "Grammar for Beginners V2 第 21 天教材", author: "Happy eBook 編輯部", category: "英語學習", type: "web", format: "網站閱讀", cover: "../assets/images/book-grammar-beginners.svg", description: "收錄 Grammar for Beginners V2 規劃 21 天的英文文法教材，適合學生自學、課堂補充與教師教學使用。", downloadUrl: "", buyUrl: "", readUrl: "https://j945935cy.github.io/Grammar-for-Beginners-V2/day21/", featured: true, popular: true, priceLabel: "免費閱讀" },
