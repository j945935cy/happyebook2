const sampleBooks = [
  ...
  { id: "grammar-beginners-v2", title: "英文文法", subtitle: "42 章教材", author: "Happy eBook 編輯部", category: "英語學習", type: "web", format: "網站閱讀", cover: "../assets/images/book-grammar-beginners.svg", description: "完整整理英文文法重點，從基礎到進階循序編排，適合學生學習與教師教學使用。", downloadUrl: "", buyUrl: "", readUrl: "https://j945935cy.github.io/Grammar-for-Beginners-V2/", featured: true, popular: true, priceLabel: "免費閱讀" },
