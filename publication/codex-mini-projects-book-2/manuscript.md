...
本章如果要放圖，可以放一張「第二組 10 個小作品學習路線」示意圖。它不需要很複雜，只要讓讀者看出：表單工具、地圖資料、視覺狀態、遊戲互動、Prompt 工具，是由簡單到進階的安排。
...
本章建議放一張完成畫面截圖：畫面中至少要看得到餐點、數量輸入、小計與總金額。若能再放一張手機版截圖，讀者會更容易理解表格或卡片在窄畫面下應該怎麼呈現。
...
本章建議放兩張圖：第一張是完整台灣路線畫面，第二張是到達某一站後，美食圖與小野狼縮圖更新的畫面。這能讓讀者知道「資料切換」不只是文字變化，也包含地圖、縮圖與累計資訊同步更新。
...
本章建議放一張台南地圖與行程卡片同時出現的截圖。若版面允許，也可以加一張手機版截圖，特別展示「下一站資訊」靠近路線圖的位置。
...
本章建議放一張嘉義版首頁畫面，讓讀者看到同一套範本換成不同城市後，標題、地圖、站點與食物都已經同步替換。圖說可以特別提醒：複製範本後，最重要的是檢查舊城市殘留。
...
本章建議放一張彰化版桌機畫面，以及一張手機版路線畫面。手機版截圖要能看出「目前站點」和「下一站資訊」沒有被拆得太遠，這是本章最重要的版面檢查點。
...
本章建議放兩張季節截圖，例如春與冬。圖說要說明同一張主圖如何透過色調、點綴與文字變化，讓使用者感覺到季節流轉。
...
本章建議放一張四種場合的對照圖，或至少放一張目前場合切換後的完成畫面。圖說要提醒讀者：這個作品的檢查重點是「圖片、穿搭名稱、建議文字」三者要同步。
...
本章建議放一張飛機在台灣地圖上巡航的截圖，並在圖說中標出高度、速度、下一站導航與到站紀錄。這些資訊能幫讀者理解「狀態數值」如何變成畫面回饋。
...
本章建議放一張遊戲進行中的截圖，畫面中要有玩家、子彈、敵人、分數與生命。若能再放一張遊戲結束或重新開始畫面，讀者會更容易知道完整遊戲流程長什麼樣。
...
本章建議放一張左右分欄或上下分區的截圖：一邊是表單欄位，一邊是產出的任務設定。圖說可以提醒讀者，這個作品的重點不是版面多華麗，而是輸出內容能不能直接拿去使用。
...
本章建議放一張小作品首頁或作品集入口截圖。圖說可以標出：讀者應該能從入口找到第二組 10 個作品，也能從每個作品回到入口。
